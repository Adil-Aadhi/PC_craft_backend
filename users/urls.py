...
from .views import ProfileView,UpdateProfileImage,UserAddressView,ChangePasswordView,ChangeEmailView,EmailChangeVerifyView,UpdateEmailView,UserAddressDetailView,SetDefaultAddressView
